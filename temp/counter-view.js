(function(){
	...
	*/
    ...
    /**
    * init events when data source type is html
    * @param {Object} context
    */
    var initHTMLEvents = function(context){
    ...
    /**
    * init events when data source type is server
    * @param {Object} context
    */
    var initServerEvents = function(context){
	...
	*/
	var initEvents = function(context){
        ...
        if(context.options.dataSource.type === 'html'){
            
            initHTMLEvents(context);
        }
		else{
            initServerEvents(context);
        }
	};
